...
public class FirstKingdomSearchResultFreeEntryProcedure {
	public static boolean execute(LevelAccessor world, Entity entity, HashMap guistate) {
		...
		return Output || (KingdomName).equals((entity.getCapability(KingdomComeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new KingdomComeModVariables.PlayerVariables())).InvitedTo);
	}
}
